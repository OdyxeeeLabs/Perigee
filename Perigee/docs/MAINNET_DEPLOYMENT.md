...
This guide covers installing the Perigee CLI, running a local simulation, and preparing for Stellar Mainnet deployment.
...
cargo build --release -p Perigee-core

# The binary is at:
./target/release/Perigee-core
```

To make it available system-wide:

```bash
cp target/release/Perigee-core /usr/local/bin/Perigee
Perigee --help
```
