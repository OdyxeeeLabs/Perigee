...
This document describes how the Perigee frontend persists WASM analysis results across page refreshes using browser local storage.
...
The latest analysis is stored under the key: `Perigee-latest-analysis`
...
| --------------- | --------------------------- | ------------------------------- |
| **Storage Key** | `Perigee-latest-analysis`   | `soroban-invocation-history`    |
...
4. **Invalid Storage**
   ...
   - Manually corrupt the `Perigee-latest-analysis` value
   - Refresh the page
