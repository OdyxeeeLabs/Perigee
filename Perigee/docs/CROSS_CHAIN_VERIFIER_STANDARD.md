...
The reference implementation is available in the Perigee repository:

- **Contract**: `contracts/cross_chain_verifier/src/lib.rs`
- **Tests**: `contracts/cross_chain_verifier/src/test.rs`
- **Repository**: https://github.com/SoroLabs/Perigee
...
- **GitHub Issues**: https://github.com/SoroLabs/Perigee/issues
- **Documentation**: https://github.com/SoroLabs/Perigee/tree/main/docs
