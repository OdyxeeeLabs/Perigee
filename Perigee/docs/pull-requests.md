...
1.  Click the **Fork** button at the top of the [Soroban Scope repository](https://github.com/SoroLabs/Perigee).
2.  Clone your fork locally:
    ```bash
    git clone https://github.com/YOUR_USERNAME/Perigee.git
    cd Perigee
    ```
3.  Add the original repository as an `upstream` remote:
    ```bash
    git remote add upstream https://github.com/SoroLabs/Perigee.git
    ```
...
1.  Commit and push your branch:
    ...
    ```
2.  Go to the [Soroban Scope PR page](https://github.com/SoroLabs/Perigee/pulls).
