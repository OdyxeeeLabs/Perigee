...
Release: Testnet release of SoroLabs/Perigee — curated set of new contracts, security tooling, and integration tests for the Soroban ecosystem.
...
- Merkle Tree CLI: `Perigee-core merkle build-file <path>` generates a root hash from a newline-delimited leaf file.
...
Perigee-core merkle build leaf1 leaf2 leaf3

# Build a tree from a newline-delimited file
Perigee-core merkle build-file leaves.txt

# Generate a proof for leaf at index 0
Perigee-core merkle proof 0 leaf1 leaf2 leaf3
```
